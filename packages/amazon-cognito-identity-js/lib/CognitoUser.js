...
var userAgent = isNavigatorAvailable
	? _Platform.Platform.isReactNative
		? 'react-native'
		: navigator.userAgent
	: 'nodejs';
...
var CognitoUser = /*#__PURE__*/ (function () {
	...
	_proto.authenticateUserDefaultAuth = function authenticateUserDefaultAuth(
		...
		var _this2 = this;
		var authenticationHelper = new _AuthenticationHelper['default'](
		...
		authenticationHelper.getLargeAValue(function (errOnAValue, aValue) {
			...
			_this2.client.request('InitiateAuth', jsonReq, function (err, data) {
				...
				_this2.userDataKey =
					_this2.keyPrefix + '.' + _this2.username + '.userData';
				serverBValue = new _BigInteger['default'](
				...
				authenticationHelper.getPasswordAuthenticationKey(
					...
					function (errOnHkdf, hkdf) {
						...
						var concatBuffer = _buffer.Buffer.concat([
							_buffer.Buffer.from(_this2.pool.getUserPoolName(), 'utf8'),
							_buffer.Buffer.from(_this2.username, 'utf8'),
							_buffer.Buffer.from(challengeParameters.SECRET_BLOCK, 'base64'),
							_buffer.Buffer.from(dateNow, 'utf8'),
						]);
						...
						var signatureString =
							_buffer.Buffer.from(resultFromAWSCrypto).toString('base64');
		...
		authenticationHelper.generateHashDevice(
			...
			function (errGenHash) {
				...
				var deviceSecretVerifierConfig = {
					Salt: _buffer.Buffer.from(
						authenticationHelper.getSaltDevices(),
						'hex'
					).toString('base64'),
					PasswordVerifier: _buffer.Buffer.from(
		...
		authenticationHelper.getLargeAValue(function (errAValue, aValue) {
			...
			_this6.client.request(
				...
				function (err, data) {
					...
					var challengeParameters = data.ChallengeParameters;
					var serverBValue = new _BigInteger['default'](
						challengeParameters.SRP_B,
						16
					);
					...
					authenticationHelper.getPasswordAuthenticationKey(
						...
						function (errHkdf, hkdf) {
							...
							var dateNow = dateHelper.getNowString();
							var concatBuffer = _buffer.Buffer.concat([
								_buffer.Buffer.from(_this6.deviceGroupKey, 'utf8'),
								_buffer.Buffer.from(_this6.deviceKey, 'utf8'),
								_buffer.Buffer.from(challengeParameters.SECRET_BLOCK, 'base64'),
								_buffer.Buffer.from(dateNow, 'utf8'),
							]);
							var awsCryptoHash = new _sha256Js.Sha256(hkdf);
	...
	_proto.refreshSession = function refreshSession(
		...
		this.client.request('InitiateAuth', jsonReq, function (err, authResult) {
			...
			if (authResult) {
				...
				_this15.signInUserSession =
					_this15.getCognitoUserSession(authenticationResult);
				_this15.cacheTokens();
