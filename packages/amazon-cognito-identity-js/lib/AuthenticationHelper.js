...
function randomBytes(nBytes) {
	return _buffer.Buffer.from(
		new _WordArray['default']().random(nBytes).toString(),
		'hex'
	);
}
/**
...
var AuthenticationHelper = /*#__PURE__*/ (function () {
	...
	function AuthenticationHelper(PoolName) {
		...
		this.k = new _BigInteger['default'](
	...
	_proto.generateHashDevice = function generateHashDevice(
		...
		this.SaltToHashDevices = this.padHex(
			new _BigInteger['default'](hexRandom, 16)
		);
		this.g.modPow(
			new _BigInteger['default'](
	...
	_proto.computehkdf = function computehkdf(ikm, salt) {
		var infoBitsBuffer = _buffer.Buffer.concat([
			this.infoBits,
			_buffer.Buffer.from(String.fromCharCode(1), 'utf8'),
		]);
	...
	_proto.getPasswordAuthenticationKey = function getPasswordAuthenticationKey(
		...
		var xValue = new _BigInteger['default'](
		...
		this.calculateS(xValue, serverBValue, function (err, sValue) {
			...
			var hkdf = _this4.computehkdf(
				_buffer.Buffer.from(_this4.padHex(sValue), 'hex'),
				_buffer.Buffer.from(_this4.padHex(_this4.UValue), 'hex')
			);
			callback(null, hkdf);
		});
	};
	...
	_proto.padHex = function padHex(bigInt) {
		...
		if (isNegative) {
			...
			var flippedBitsBI = new _BigInteger['default'](invertedNibbles, 16).add(
				_BigInteger['default'].ONE
			);
