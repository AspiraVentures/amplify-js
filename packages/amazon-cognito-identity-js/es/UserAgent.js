...
export var appendToCognitoUserAgent = function appendToCognitoUserAgent(
	content
) {
	if (!content) {
		return;
...
export var addAuthCategoryToCognitoUserAgent =
	function addAuthCategoryToCognitoUserAgent() {
		UserAgent.category = AUTH_CATEGORY;
	};
export var addFrameworkToCognitoUserAgent =
	function addFrameworkToCognitoUserAgent(framework) {
...
export var getAmplifyUserAgent = function getAmplifyUserAgent(action) {
	...
	var uaFramework = UserAgent.framework
		? ' framework/' + UserAgent.framework
		: '';
	var userAgent =
		'' + UserAgent.prototype.userAgent + uaCategoryAction + uaFramework;
	return userAgent;
};
